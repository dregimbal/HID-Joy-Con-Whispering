...
unsigned short vendor_ids_size = 2;
unsigned short vendor_ids[] = {NINTENDO_VENDOR_ID, HORI_VENDOR_ID};

#define JOYCON_L_BT (0x2006)
#define JOYCON_R_BT (0x2007)
#define PRO_CONTROLLER (0x2009)
#define JOYCON_CHARGING_GRIP (0x200e)
#define HORI_WIRELESS_HORIPAD (0x00f6)

unsigned short product_ids_size = 5;
unsigned short product_ids[] = {JOYCON_L_BT, JOYCON_R_BT, PRO_CONTROLLER, JOYCON_CHARGING_GRIP, HORI_WIRELESS_HORIPAD};
                ...
                if(dev_iter->interface_number == 0 || dev_iter->interface_number == -1)
                {
                    ...
                    switch(dev_iter->product_id)
                    {
                        ...
                        case JOYCON_R_BT:
                            ...
                            handle_r = handle;
                            break;
                        case HORI_WIRELESS_HORIPAD:
                            device_name = L"Hori Wireless Horipad";
